/* DAFTAR ISI
---------------------------------------------------------------------------------------------------
- konsep 			-> konfig dasar (kombinasi packet-mark dan HTB)
- packet mark 		-> membuat penanda mangle packet-mark
...
queue tree adalah methode manajemen bandwidth dengan pola hirarchi HTB. isyu umum 
	...
	- berguna juga mengatur 'hubungan' parent dan child
	- juga mengatur 'priority' antar child
	- juga mengatur child2 secara 'independen' misalnya queue type nya berbeda dsb
---------------------------------------------------------------------------------------------------
